...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header"><h4>Agent Ticket List</h4></div>
                <div class="card-body">
                            ...
                            <td class="text-center">  
                              <div class="dropdown dropright">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                    <a href="{{ route("guzbyte.admin.agent.ticket.show", [$ticket->id, $ticket->slug]) }}" class="dropdown-item"><i class="fa fa-eye" ></i> View ticket</a>
                                    @if ($ticket->status_id == 1)
                                      <a href="{{ route("guzbyte.ticket.agent.edit", [$ticket->id]) }}" class="dropdown-item" type="button"><i class="fa fa-edit"></i> Edit ticket</a>
                                      <a href="{{ route("guzbyte.ticket.admin.close.ticket", [$ticket->id]) }}" class="dropdown-item"><i class="fa fa-trash"></i> Close Ticket</a>
                                    @endif
                                </div>
                              </div>
